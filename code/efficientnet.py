...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None, num_classes= 1000):
        ...
        self._conv_head = Conv2d(in_channels, out_channels, kernel_size=1, stride=2, bias=False)
    ...
    def forward(self, inputs):
        ...
        # print("initial layer size", x.size())
        # Block 1
        x= self.extract_features_block1(x)
        # print("Block 1 layer size", low_level_features.size())
        # Block 2
        x= self.extract_features_block2(x)
        # print("Block 2 layer size", mid_level_features.size())
        # Block 3
        x= self.extract_features_block3(x)
        # print("Block 3 layer size", high_level_features.size())
        # Block 4
        x = self.extract_features_block4(x)
        # Block 5
        x = self.extract_features_block5(x)
        ## head
        x = self._swish(self._bn1(self._conv_head(x)))
        # print("Block head layer size", x.size())
